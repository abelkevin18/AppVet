		...
		<div class="content">
							...
							<c:forEach var="mascota" items="${mascotas}">
								...
								<tr id="trs">
									...
									<td><button type='button' id='${mascota.idmascota}'
										...
										href="${pageContext.request.contextPath}/historiaclinica/${mascota.idmascota}"
										class="btn btn-info btn-round" title="Ver historia clinica">
								...
								<form>
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<label>Características:</label>
												<textarea class="form-control" id="caracteristicas_"
													rows="3"></textarea>
											</div>
										</div>
									</div>
			...
			<div class="modal fade" id="modalListaClientes" tabindex="-1" role="">
				<div class="modal-dialog modal-lg" role="document">
					<div class="modal-content">
						<div class="card">
							<div class="card-header">Elegir el propietario de la
								mascota</div>
							<div class="card-body">
